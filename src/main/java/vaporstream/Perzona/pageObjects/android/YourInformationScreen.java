...
public class YourInformationScreen extends AndroidActions{

	AndroidDriver driver;	

	public YourInformationScreen(AndroidDriver driver) {
		super(driver); 
		this.driver = driver; 
...
//	@AndroidFindBy(xpath="//android.widget.LinearLayout[@content-desc=\"maleProfile.jpg, 18.83 kB, Sep 6\"]/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.ImageView[2]")
	@AndroidFindBy(xpath="//android.widget.LinearLayout[@content-desc=\"maleProfile.jpg, 18.83 kB, Sep 6\"]/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.ImageView")
...
//		driver.hideKeyboard();
	...
	public void setMoreInfo(String aboutUser, String websiteUrl, String username) throws InterruptedException {
