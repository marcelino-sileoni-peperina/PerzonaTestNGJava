...
public class SignUpListeners extends AppiumUtils implements ITestListener {
	 ...
	 * Boolean contactSyncTest = (Boolean) parameterValues[16];
	 * 
	 * test.log(Status.INFO, MarkupHelper.createLabel("<b>Testing Paramaters</b>",
	 * ExtentColor.GREY));
	 * test.log(Status.INFO, "Country Code: " + countryCode);
	 * test.log(Status.INFO, "Country Name: " + countryName);
	 * test.log(Status.INFO, "Use Aleatory Phone Number: " + (randomPhoneNumber ?
	 * "Yes" : "No"));
	 * if (!randomPhoneNumber)
	 * test.log(Status.INFO, "Phone Number: " + phoneNumber);
	 * test.log(Status.INFO, "Test Invalid Phone Number: " + (invalidPhoneNumberTest
	 * ? "Yes" : "No"));
	 * test.log(Status.INFO, "Test Phone Number Edition: " + (editPhoneNumberTest ?
	 * "Yes" : "No"));
	 * test.log(Status.INFO, "Test Invalid OTP: " + (wrongOTPTest ? "Yes" : "No"));
	 * test.log(Status.INFO, "Test OTP timeout: " + (delayedOTPTest ? "Yes" :
	 * "No"));
	 * test.log(Status.INFO, "Full Name: " + fullName);
	 * test.log(Status.INFO, "Use Aleatory Username Value: " + (randomUsername ?
	 * "Yes" : "No"));
	 * if (!randomUsername)
	 * test.log(Status.INFO, "User Name: " + username);
	 * test.log(Status.INFO, "Include Avatar on Test: " + (setAvatar ? "Yes" :
	 * "No"));
	 * if (setAvatar)
	 * test.log(Status.INFO, "Profile Gender: " + profileGender);
	 * test.log(Status.INFO, "Add User Additional Information: " +
	 * (setAdditionalInfo ? "Yes" : "No"));
	 * if (setAdditionalInfo) {
	 * test.log(Status.INFO, "About User Info: " + aboutUser);
	 * test.log(Status.INFO, "WebSite of User: " + websiteUrl);
	 * }
	 * test.log(Status.INFO, "Add Contacts Syncronizaton Test: " + (contactSyncTest
	 * == true ? "Yes" : "No"));
	 * 
...
// PRUEBAS
// test.log(Status.INFO, "Mensaje de Prueba > <i>Texto con formato
// ITALICO</i>");
// test.log(Status.INFO, "Mensaje de Prueba > <b>Texto con formato BOLD</b>");
// test.log(Status.INFO, "Mensaje de Prueba > <u>Texto con formato
// UNDERLINE</u>");
...
// XML Content
// String xmlContent = "<menu id=\"file\" value=\"This is an example of XML
// Content on a report log\">\r\n"
// + " <popup>\r\n" + " <menuitem value=\"New\" onclick=\"CreateNewDoc()\"
// />\r\n"
// + " <menuitem value=\"Open\" onclick=\"OpenDoc()\" />\r\n"
// + " <menuitem value=\"Close\" onclick=\"CloseDoc()\" />\r\n" + "
// </popup>\r\n" + "</menu>";
// test.log(Status.INFO, MarkupHelper.createCodeBlock(xmlContent,
// CodeLanguage.XML));

// JSON Content
// String jsonContent = "{\"This is an example of JSON Content on a report
// log\": {\r\n" + " \"id\": \"file\",\r\n"
// + " \"value\": \"File\",\r\n" + " \"popup\": {\r\n" + " \"menuitem\": [\r\n"
...
// }\r\n" + "}}";
// test.log(Status.INFO, MarkupHelper.createCodeBlock(jsonContent,
// CodeLanguage.JSON));
